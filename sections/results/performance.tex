...
\autoref{figure:memcpyw-mips} shows the performance of the \texttt{memcpyw(n)} test suite. This is the first test suite discusssed where performance is not monotonic with regards to \texttt{n} and starts to rapidly fall as \texttt{n} is sufficiently increased.
